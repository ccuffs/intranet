                    ...
                    @else
                        <table class="table table-bordered" style="text-align:left;">
                            <thead >
                                ...
                                <th scope="col" class="mt-3 text-gray-400" style="width:13%;padding-left:1%;" >Carga Horária</th>
                            ...
                            <tbody>
                                @foreach ($data as $certificate)
                                    ...
                                    <td class="mt-3 text-gray-400" style="padding-left:1%;">{{ $certificate->hours }}</td>
                                    <td><a class="btn" href="{{ $certificate->link }}"><x-fas-download class="w-4 h-4 text-gray-400" /></a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
